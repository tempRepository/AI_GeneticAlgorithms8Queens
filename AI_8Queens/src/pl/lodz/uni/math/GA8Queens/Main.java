...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfPopulationQuantity.setText("1000");
                                                                                        ...
                                                                                        layout.createSequentialGroup()
                                                                                                ...
                                                                                                .addGroup(
                                                                                                        layout.createParallelGroup(
                                                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                                                                .addComponent(
                                                                                                                        lblPopulationQuantity)
                                                                                                                .addComponent(
                                                                                                                        tfPopulationQuantity,
        ...
        layout.setVerticalGroup(layout
                ...
                .addGroup(
                        layout.createSequentialGroup()
                                ...
                                .addPreferredGap(
                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btTest).addContainerGap()));
    ...
    private void btTestActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btTestActionPerformed
        ...
        Population population = new Population(
                Integer.parseInt(tfPopulationQuantity.getText()));
        int best = -1;
        boolean worthReplaying = true;
        while (worthReplaying) {
            worthReplaying = false;
            for (int i = 0; i < Integer.parseInt(tfIteration.getText())
                    && best == -1; i++) {
                ...
                if (best != -1) {
                    taOutput.append("\n\n"
                            + population.getChessBoards().get(best).toString());
                }
            ...
            if (best == -1 && greatnessBefore < greatnessAfter) { //
                ...
                taOutput.append("\n Nie znaleziono rozwiązania w zadanej ilości iteracji \n");
            }
        }
